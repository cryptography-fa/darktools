...
import re, pkgutil, platform, signal
...
def geo():
    site = raw_input(w + ' [' + g + '+' + w + '] masukan TARGET > \x1b[96m')
    cover = wongedan(site)
...
def main():
    try:
        choice = raw_input(r + '\n \xe2\x94\x8c\xe2\x94\x80' + b + '[' + r + 'DarkTools' + a + '@' + g + 'Zone-Xploiter' + b + ']' + r + '-' + b + '[' + g + 'Type The Command' + b + ']\n ' + r + '\xe2\x94\x94\xe2\x94\x80\xe2\x94\x80\xe2\x94\x80\xe2\x94\x80\xe2\x94\x80' + y + '\xe2\x96\xb6' + w + ' # ')
